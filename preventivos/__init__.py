...
signals.post_save.connect(registro_post_save, sender=Hechos)
signals.post_save.connect(registro_post_save, sender=HechosDelito)
signals.post_save.connect(registro_post_save, sender=Elementos)
signals.post_save.connect(registro_post_save, sender=PersInvolucradas)
signals.post_save.connect(registro_post_save, sender=Lugar)
signals.post_save.connect(registro_post_save, sender=User)
#Signals postdelete
signals.post_delete.connect(registro_post_delete, sender=HechosDelito)
signals.post_delete.connect(registro_post_delete, sender=Elementos)
...
# Listener Signals
@receiver([post_save, post_delete], sender=Preventivos, weak=False)
def send_update(sender, **kwargs):
    #print kwargs.get('user')
    signal = kwargs.get('signal', None)
    user = kwargs.get('instance')
    obj=kwargs['instance']
    ntabla="Preventivos id_nro :"+str(obj)
    if signal == post_save:
        action = "Grabar"
    elif signal == post_delete:
        action = "Eliminar/Borrar"
