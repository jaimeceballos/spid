...
urlpatterns = patterns('',
    ...
    url(r'^cargar_nuevo_procesales/(?P<prontuario>[0-9A-Za-z]+)/(?P<apellido>[A-Za-z]+)/(?P<nombre>[A-Za-z]+)/(?P<dni>[0-9A-Za-z]+)/$','prontuario.views.nuevo_procesales',name='cargar_nuevo'),
